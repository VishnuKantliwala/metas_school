...
<?
$sql1 = $cn->selectdb("SELECT course_name, slug, description FROM tbl_course  order by recordListingID ASC LIMIT 6");
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30"
                    ...
                    data-ipad-device-dots="false" data-md-device="3" data-md-device-nav="true"
                    ...
                    <div class="testimonial-style3">
                        ...
                        <h5 class="title list-title list-title--course">
                            <?echo $course_name ?>
                        </h5>
                ...
                <div class="rs-carousel owl-carousel rs-navigation-2" data-loop="true" data-items="2" data-margin="30"
                    ...
                    <div class="event-item">
                        <div class="event-img">
                            ...
                            <a class="image-link" href="Event-Detail/<?php echo $row['slug'] ?>/"
                        ...
                        <div class="events-details sec-color">
                            ...
                            <h4 class="event-title"><a
                                    href="Event-Detail/<?php echo $row['slug'] ?>/"><?php echo  $row['event_title'] ?></a>
                            </h4>
                            ...
                            <div class="event-btn">
                                <a href="Event-Detail/<?php echo $row['slug'] ?>/">Read More <i
