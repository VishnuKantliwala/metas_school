...
$sqlC=$con->selectdb("SELECT cat_id FROM tbl_magazine where magazine_id=".$magazine_id."");
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Magazine Form</h4>
                                
                                <form class="form-horizontal" method="post" action="magazine_upload.php" id="myform"
                                    name="myform" enctype="multipart/form-data">
                                    <input type="hidden" name="page" id="page" value="<? echo isset($_GET['page']);?>">

                                    <?php
										$records=$cn->selectdb("SELECT * FROM tbl_magazine where magazine_id=".$magazine_id."");
                                    ...
                                    <div class="form-group" style="display:none">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="year" name="year"
                                                placeholder="Year" value="<?php echo $row[15]; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Magazine Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="magazine_name" name="magazine_name" value="<?php echo $row[1]; ?>" placeholder="Magazine Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="display:none">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" data-default-file="<?if($row[4]!=''){echo '../magazine/'.$row[4];}?>" class="dropify"/>
                                            <? if($row[4]!=''){?>
                                            <!-- <img src="../magazine/<? echo $row[4];?>" width="100"> -->
                                            <a href="magazine_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                                                ...
                                                                <li class="list-inline-item file-box">
                                                                    <div class=" custom-control custom-switch">
                                                                        ...
                                                                        <label class="custom-control-label" for="<?php echo $image_list[$i]; ?>">
                                                                            <img src="../magazineF/<?php echo $image_list[$i]; ?>" class="img-fluid img-thumbnail" alt="attached-img" width="80">
                                                                        </label>
                                                                    </div>
                                                                </li>
                                                    <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <? if($row['pdf_file']!=''){?>
                                                <a href="magazine_upload.php?id=<?php echo $row['magazine_id']; ?>&PDF=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                    ...
                                    <div class="form-group" style="display:none">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Magazine Video</label>
                                        <div class="col-sm-12">
                                            <textarea cols="5" rows="5" class="form-control" id="magazine_video" name="magazine_video" placeholder="Embeded code of the video"><?php echo $row[16]?></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group" style="display:none">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Magazine Map</label>
                                        <div class="col-sm-12">
                                            <textarea cols="5" rows="5" class="form-control" id="magazine_map" name="magazine_map" placeholder="Embeded code of the Map"><?php echo $row[17]?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" name="updateMagazine" id="updateMagazine" class="btn btn-success">Update</button>
                                            <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='magazineView.php'; return false;">Cancel</button>
                                        </div>
                                    </div>
