...
$query = $cn->selectdb('SELECT * FROM tbl_video_category');
                        ...
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="video_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Video Name</label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Video URL</label>
                                        <div class="col-sm-12">
                                            <textarea cols="80" class="form-control" id="video_url" name="video_url" rows="10"></textarea>
                                        </div>
                                    </div>
