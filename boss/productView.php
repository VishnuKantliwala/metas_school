...
$sql = $cn->selectdb("SELECT * FROM tbl_product order by product_id desc");
...
$i=2;
$sql1=$con->selectdb("SELECT * FROM tbl_product");												
						 //print_r($sql1);
...
$multi_images = trim($allDataInSheet[$i]["F"]);
	...
	if($existid>0) {
		...
		$insertTable= $con->selectdb("UPDATE tbl_product SET product_name = '".$product_name."', description = '".$description."',cat_id = '".$cat_id."',product_image = '".$product_image."',multi_images = '".$multi_images."' WHERE product_id = ".$product_id.";");
		...
		$insertTable= $con->selectdb("INSERT INTO tbl_product (product_id,product_name, description, cat_id,product_image,multi_images) VALUES ('".$product_id."','".$product_name."', '".$description."', '".$cat_id."','".$product_image."','".$multi_images."');");
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Extramarks Online Learning View</h4>
                                <?php
                                    ...
                                    for($i=0;$i<$cnt;$i++)
                                    {
                                        ...
                                        //$con->selectdb("delete from `tbl_product` where product_id=".$del_id);
                                    }
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap">
										...
										?>
                                            <tr>
												...
												<td><a href='product_up.php?product_id=<?php echo $product_id ?>&page=<? echo isset($_GET['page']);?>'><i class="fa fa-edit"></i></a></td>
												<!-- <td><a href='delete_rec.php?tablename=tbl_product&primarykey=product_id&id=<?php echo $product_id ?>&page=<? echo isset($_GET['page']);?>' onClick="return confirm('Are you sure want to delete?');"><i class="fa fa-trash"></i></a></td> -->
                                            </tr>
											<? } } ?>
