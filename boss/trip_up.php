            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Trip Form</h4>
                                <form class="form-horizontal" method="post" action="trip_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    {
                                    ?>
                                    <input type="hidden" name="trip_id" id="trip_id" value="<?php echo $row[0]; ?>" />	
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Trip Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="trip_name" name="trip_name" value="<?php echo $row[1]; ?>" placeholder="Trip Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[4]!=''){echo "../trip/".$row[4];}?>"/>
                                            <? if($row[4]!=''){?>
                                                <a href="trip_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                                                ...
                                                                <li class="list-inline-item file-box">
                                                                    <div class=" custom-control custom-switch">
                                                                        ...
                                                                        <label class="custom-control-label" for="<?php echo $image_list[$i]; ?>">
                                                                            <img src="../tripF/<?php echo $image_list[$i]; ?>" class="img-fluid img-thumbnail" alt="attached-img" width="80">
                                                                        </label>
                                                                    </div>
                                                                </li>
                                                    <?php
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-12">
                                            ...
                                            <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='tripView.php'; return false;" >Cancel</button>
                                        </div>
                                    </div>
