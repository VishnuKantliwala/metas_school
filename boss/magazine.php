...
$query = $cn->selectdb('SELECT * FROM tbl_category');
                        ...
                        foreach($menuItems as $key => $value)
                        {
                            ...
                            {    
                                ...
                                if($value['cat_parent_id'] == 0 && in_array($key, $parentMenuIds))
                                {
                                    ...
                                    // echo '<li class="dropdown"><a class="dropdown-toggle"  href="">' . $value['cat_name'] . '<b class="caret"></b></a>';
                                }
                                else if($value['cat_parent_id'] != 0 && in_array($key, $parentMenuIds))
                                {
                                    echo '<li data-jstree='.'{"opened":true}'.'><a href="category.php?id=' . $key . '">' . $value['cat_name'] . '</a>';

                                //   echo '<li class="dropdown-submenu"><a href="category.php?id=' . $key . '">' . $value['cat_name'] . '</a>';
                                }
                                else
                                {
                                ...
                                //   echo '<li><div class="custom-control custom-switch"><input type="checkbox" class="custom-control-input" id="customSwitch'.$key.'" name="mulradio[]" value="'.$key.'" /><label class="custom-control-label" for="customSwitch'.$key.'">' . $value['cat_name'] . '</label></div>';
                                }
                                generate_menu($key);
                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="magazine_upload.php" id="myform"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="magazine_name" name="magazine_name" placeholder="Extramarks Online Learning Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" style="display:none">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Magazine Video</label>
                                            <div class="col-sm-12">
                                                <textarea cols="5" rows="5" class="form-control" id="magazine_video" name="magazine_video" placeholder="Embeded code of the video"></textarea>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group" style="display:none">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Magazine Map</label>
                                            <div class="col-sm-12">
                                                <textarea cols="5" rows="5" class="form-control" id="magazine_map" name="magazine_map" placeholder="Embeded code of the Map"></textarea>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" name="addMagazine" id="addMagazine" class="btn btn-success">Add</button>
