            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">House Form</h4>
                                <form class="form-horizontal" method="post" action="house_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <?php
                                    $records=$con->selectdb("SELECT * FROM tbl_house where house_id=".$house_id."");
                                    while($row=mysqli_fetch_array($records))
                                    {
                                    ?>
                                    <input type="hidden" name="house_id" id="house_id" value="<?php echo $row[0]; ?>" />	
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">House Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="house_name" name="house_name" value="<?php echo $row[1]; ?>" placeholder="House Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[4]!=''){echo "../house/".$row[4];}?>"/>
                                            <? if($row[4]!=''){?>
                                                <a href="house_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
