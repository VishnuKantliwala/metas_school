            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 mb-2 header-title">Project Category Form</h4>
                                <form class="form-horizontal" method="post" action="project_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    <?php
                    
                                    $records=$con->selectdb("SELECT * FROM tbl_project_category  where cat_id=".$category_id."");
                                    ...
                                    ?>
										...
										<div class="form-group">
											...
											<div class="col-sm-12">
                                                ...
                                                <?php if($row[4]!=''){?>
												    <a class="btn btn-lighten-danger" href="project_upload.php?id=<?php echo $row[0]; ?>&Image=Del" onClick="return confirm('Are you sure want to delete?');">Delete</a>
											    <?php }?>  
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
												...
												<button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='projectCatView.php'; return false;" >Cancel</button>
                                            </div>
                                        </div>
									<? } ?>	
                                </form>
