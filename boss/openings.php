...
$query = $cn->selectdb('SELECT * FROM tbl_openings_category');
                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="openings_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="openings_title" name="openings_title" placeholder="Name">
                                        </div>
                                    </div>	
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" id="openings_date" name="openings_date" placeholder="Date">
                                        </div>
                                    </div>						
