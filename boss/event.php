...
$query = $cn->selectdb('SELECT * FROM tbl_event_category');
                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="event_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="event_title" name="event_title" placeholder="Name">
                                        </div>
                                    </div>	
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" id="event_date" name="event_date" placeholder="Date">
                                        </div>
                                    </div>						
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Event Time</label>
                                        <div class="col-sm-12">
                                            
                                            <input type="text" class="form-control" id="meta_tag_description" name="meta_tag_description" placeholder="Event Time"  value="<?php echo $row[6]?>">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Event Venue</label>
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" class="form-control" id="meta_tag_keywords" name="meta_tag_keywords" placeholder="Event Venue"  value="<?php echo $row[7]?>">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group" >
                                        <label for="inputEmail3" class="col-sm-2 control-label">Image (2 : 1)</label>
                                        <div class="col-sm-4">
