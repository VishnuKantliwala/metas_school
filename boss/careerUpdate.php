...
if(isset($_POST['updateSlider']))
{
			...
			$con->insertdb("UPDATE `tbl_career` SET `career_title` = '".$career_title."', `description` = '".$description."', meta_tag_title='".$meta_tag_title."',meta_tag_description='".$meta_tag_description."',meta_tag_keywords='".$meta_tag_keywords."',slug='".$slug."' WHERE `tbl_career`.`career_id` = '".$career_id."'");
                        ...
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <input type="hidden" name="page" id="page" value="<? echo $_GET['page'];?>">
									 ...
									 <?php
										$records=$con->selectdb("SELECT * FROM tbl_career where career_id=".$career_id."");
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="career_title" name="career_title" placeholder="Name" value="<? echo $row['career_title']; ?>">
                                            </div>
                                        </div>										
