            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 mb-2 header-title">Blog Category Form</h4>
                                <form class="form-horizontal" method="post" action="blog_upload.php" id="myform" name="myform" enctype="multipart/form-data">
									<?php
					
									$records=$con->selectdb("SELECT * FROM tbl_blogcategory  where cat_id=".$category_id."");
                        			...
                        			<input type="hidden" id="cat_parent_id" name="cat_parent_id" value="<?php echo $row[1]; ?>" />
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-12">
											<input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[4]!=''){echo '../blogcategory/'.$row[4];}?>"/>
                                        </div>
											
											<div class="col-sm-10">
											<input type="hidden" id="frontimg2" name="frontimg2" value="<?php echo $row[4]?>" />
                                              <?php if($row[4]!=''){?>
												  <a href="blog_upload.php?id=<?php echo $row[0]; ?>&Image=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
											    <?php }?>  
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
												...
												&nbsp;&nbsp;
												<button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='blogCatView.php'; return false;" >Cancel</button>
                                            </div>
                                        </div>
									<? } ?>	
                                </form>
