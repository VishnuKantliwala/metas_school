...
$sql = $cn->selectdb("SELECT * FROM tbl_alumni WHERE status = 1  order by alumni_id desc");
                            ...
                            <div class="card-box">
                                ...
                                <?php
                                    ...
                                    for($i=0;$i<$cnt;$i++)
                                    {
                                        ...
                                        echo "<script>window.open('alumniView.php','_SELF')</script>";
                                    }
                                ?>
                                ...
                                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="alumni.php" class="btn btn-success m-b-sm mt-2 mb-2">Add</a>
                                            <a href="sorting_alumni.php" class="btn btn-success m-b-sm mt-2 mb-2">Sort</a>
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><a href='alumni_disable.php?id=<?php echo $alumni_id ?>'><i class="fa fa-ban"></i></a></td>
                                                        
                                                        <td><a href='alumni_up.php?alumni_id=<?php echo $alumni_id ?>&page=<? echo isset($_GET['page']);?>'><i class="fa fa-edit"></i></a></td>
