                        ...
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="download_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    $records=$con->selectdb("SELECT * FROM tbl_downloadcategory  where cat_id=".$category_id."");
                                    ...
                                    ?>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-4">
											    <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[4]!=''){echo "../downloadcategory/".$row[4];}?>"/>
                                            </div>
											<div class="col-sm-12">
                                                <input type="hidden" id="frontimg2" name="frontimg2" value="<?php echo $row[4]?>" />
                                                <?php if($row[4]!=''){?>
												    <a class="btn btn-lighten-danger" href="download_upload.php?id=<?php echo $row[0]; ?>&Image=Del" onClick="return confirm('Are you sure want to delete?');">Delete</a>
											    <?php }?>  
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
												...
												<button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='downloadCatView.php'; return false;" >Cancel</button>
                                            </div>
                                        </div>
									<? } ?>	
                                </form>
