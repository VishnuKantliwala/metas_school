...
$sqlC=$con->selectdb("SELECT cat_id FROM tbl_council where product_id=".$product_id."");
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">  Council Circulars (CISCE)  Form</h4>
                                ...
                                <form class="form-horizontal" method="post" action="council_upload.php" id="myform"
                                    ...
                                    <?php
										$records=$cn->selectdb("SELECT * FROM tbl_council where product_id=".$product_id."");
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">  Council Circulars (CISCE)  Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="product_name" name="product_name" value="<?php echo $row[1]; ?>" placeholder="  Council Circulars (CISCE)  Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="display:none">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" data-default-file="<?if($row[4]!=''){echo '../council/'.$row[4];}?>" class="dropify"/>
                                            <? if($row[4]!=''){?>
                                            <!-- <img src="../council/<? echo $row[4];?>" width="100"> -->
                                            <a href="council_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                                                ...
                                                                <li class="list-inline-item file-box">
                                                                    <div class=" custom-control custom-switch">
                                                                        ...
                                                                        <label class="custom-control-label" for="<?php echo $image_list[$i]; ?>">
                                                                            <img src="../councilF/<?php echo $image_list[$i]; ?>" class="img-fluid img-thumbnail" alt="attached-img" width="80">
                                                                        </label>
                                                                    </div>
                                                                </li>
                                                    <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <? if($row['pdf_file']!=''){?>
                                                <a href="council_upload.php?id=<?php echo $row['product_id']; ?>&PDF=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
