...
$sql = $cn->selectdb("SELECT * FROM tbl_career_info order by cid desc");

function deleteCareerInfo($id)
{
	$cn=new connect();
	$cn->connectdb();
	$id = $id;
    ...
    $cn->selectdb("delete from tbl_career_info where cid=$id");
                            ...
                            <div class="card-box">
                                ...
                                <?php
									...
									for($i=0;$i<$cnt;$i++)
									{
										...
										deleteCareerInfo($del_id);
										
									}
										echo "<script>window.open('careerInfoView.php','_SELF')</script>";
									}
								?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><input type="checkbox" name="chkbox[]" class="chkbox"  value="<?echo $cid?>"/></td>
                                                        <th><? echo $cid; ?></th>
                                                        <td><a href="../career/<?echo $cresume;?>" target="newwindow"><?php echo $cname; ?></a></td>
                                                        <td><?php echo $cemail; ?></td>
                                                        <td><?php echo $cphone; ?></td>
                                                        <td><?php echo $cexperience; ?></td>
                                                        <td><?php echo $capply; ?></td>
                                                        <td><a href='deleteCareerInfo.php?Del=del&id=<?php echo $cid ?>&page=<?  if (isset($_GET['page']) && !empty($_GET['page'])) echo $_GET['page'];?>' onClick="return confirm('Are you sure want to delete?');"><i class="fa fa-trash"></i></a></td>
                                                    </tr>
                                                    <? } } ?>
