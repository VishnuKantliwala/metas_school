    ...
    $(document).ready(function(){ 
        ...
        $(function() {
            $(".sortable").sortable({ opacity: 0.6, cursor: 'move', update: function() {
                ...
                $.post("update_client.php", order, function(theResponse){
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="sortable">
                                <?php
								$query  = "SELECT * FROM tbl_client ORDER BY recordListingID ASC";
								$result = $cn->selectdb($query);
								
								while($row = mysqli_fetch_assoc($result))
								{
								?>
                                <div id="recordsArray_<?php echo $row['client_id']; ?>" class="card card-draggable">
                                    <div class="card-body bg-light">
                                        <p class="card-text"><?php echo $row['recordListingID'] . ". " . $row['client_name']; ?></p>
                                    </div>
                                </div>
								<?php } ?>
