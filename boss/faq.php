...
$con->connectdb();
	  ...
	  //print_r($_POST);die;
		...
		$con->insertdb("INSERT INTO `tbl_faq` (`faq_title`, `description`,`meta_tag_title`, `meta_tag_description`, `meta_tag_keywords`, `slug`) VALUES ('".$faq_title."', '".$description."','".$meta_tag_title."', '".$meta_tag_description."', '".$meta_tag_keywords."', '".$slug."');");
                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="#" id="myform" name="myform" enctype="multipart/form-data">				
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="faq_title" name="faq_title" placeholder="Name">
                                        </div>
                                    </div>										
