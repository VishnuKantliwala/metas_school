...
$query = $con->selectdb('SELECT * FROM tbl_gallery_category');
...
$sqlC=$con->selectdb("SELECT cat_id FROM tbl_gallery where gallery_id=".$gallery_id);
                ...
                function generate_menu($parent)
                {
                        ...
                        foreach($menuItems as $key => $value)
                        {
                            ...
                            {    
                                ...
                                {
                                    echo '<li data-jstree='.'{"opened":true}'.'><a href="galleryCategory.php?id=' . $key . '">' . $value['cat_name'] . '<b class="caret"></b></a>';
                                }
                                else if($value['cat_parent_id'] != 0 && in_array($key, $parentMenuIds))
                                {
                                    echo '<li data-jstree='.'{"opened":true}'.'><a href="galleryCategory.php?id=' . $key . '">' . $value['cat_name'] . '</a>';
                                }
                                else
                                {
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Gallery Form</h4>
                                <form class="form-horizontal" method="post" action="gallery_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    {
                                    ?>
                                    <input type="hidden" name="gallery_id" id="gallery_id" value="<?php echo $row[0]; ?>" />	
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Gallery Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="gallery_name" name="gallery_name" value="<?php echo $row[1]; ?>" placeholder="Gallery Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <? if($row[4]!=''){?>
                                                <a href="gallery_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" name="image_title[]" class="dropify" multiple/>											
                                                                ...
                                                                <li class="list-inline-item file-box">
                                                                    <div class=" custom-control custom-switch">
                                                                        ...
                                                                        <label class="custom-control-label" for="<?php echo $image_list[$i]; ?>">
                                                                            <img src="../galleryF/<?php echo $image_list[$i]; ?>" class="img-fluid img-thumbnail" alt="attached-img" width="80">
                                                                        </label>
                                                                    </div>
                                                                </li>
                                                    <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="meta_tag_title" name="meta_tag_title" placeholder="Meta Tag Title"  value="<?php echo $row[6]?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea cols="5" rows="5" class="form-control" id="meta_tag_description" name="meta_tag_description" placeholder="Meta Tag Description" ><?php echo $row[7]?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea cols="5" rows="5" class="form-control" id="meta_tag_keywords" name="meta_tag_keywords" placeholder="Meta Tag Keywords"><?php echo $row[8]?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='galleryView.php'; return false;" >Cancel</button>
                                        </div>
                                    </div>
                                    <? } ?>
                                </form>
