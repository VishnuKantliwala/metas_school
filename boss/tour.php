    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">Tours</h4>
                </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Tours Form</h4>
                                <form class="form-horizontal" method="post" action="tour_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Tours Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="tour_name" name="tour_name" placeholder="Tours Name">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Tours Venue</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="tour_venue" name="tour_venue" placeholder="Tours Venue">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="date" class="form-control" id="tour_date" name="tour_date" placeholder="Date">
                                        </div>
                                    </div>
