    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">Bands</h4>
                </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Bands Form</h4>
                                <form class="form-horizontal" method="post" action="band_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Bands Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="band_name" name="band_name" placeholder="Bands Name">
                                        </div>
                                    </div>
