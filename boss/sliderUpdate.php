...
if(isset($_POST['saveasSlider']))
{
  $slider_name = $_POST['slider_name'];
			...
			$urllink = $_POST['urllink'];
				...
				{
				$con->insertdb("INSERT INTO `tbl_slider` (`image_title`, `desc_slider`, `image_name`,`meta_tag_title`,`slug`, `link_url`) VALUES ('".$slider_name."', '".$description."', '".$meta_tag_title."', '".$slug."','".$frontimg2."', '".$urllink."');");
				}
