    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">Picnic</h4>
                </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Picnic Form</h4>
                                <form class="form-horizontal" method="post" action="picnic_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    {
                                    ?>
                                    <input type="hidden" name="picnic_id" id="picnic_id" value="<?php echo $row[0]; ?>" />	
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Picnic Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="picnic_name" name="picnic_name" value="<?php echo $row[1]; ?>" placeholder="Picnic Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="date" class="form-control" id="picnic_date" name="picnic_date" placeholder="Date" value="<?php echo $row['picnic_date']; ?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[4]!=''){echo "../picnic/".$row[4];}?>"/>
                                            <? if($row[4]!=''){?>
                                                <a href="picnic_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                                                ...
                                                                <li class="list-inline-item file-box">
                                                                    <div class=" custom-control custom-switch">
                                                                        ...
                                                                        <label class="custom-control-label" for="<?php echo $image_list[$i]; ?>">
                                                                            <img src="../picnicF/<?php echo $image_list[$i]; ?>" class="img-fluid img-thumbnail" alt="attached-img" width="80">
                                                                        </label>
                                                                    </div>
                                                                </li>
                                                    <?php
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-12">
                                            ...
                                            <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='picnicView.php'; return false;" >Cancel</button>
                                        </div>
                                    </div>
