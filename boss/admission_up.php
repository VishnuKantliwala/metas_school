...
$sqlC=$con->selectdb("SELECT cat_id FROM tbl_admission where blog_id=".$blog_id."");
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Admission Form</h4>
                                <form class="form-horizontal" method="post" action="admission_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">admission Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="blog_name" name="blog_name" placeholder="admission Name" value="<?php echo $row['blog_name']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row['blog_image']!=''){echo "../admission/".$row['blog_image'];}?>"/>
                                            <? if($row['blog_image']!=''){?>
                                                <a href="admission_upload.php?id=<?php echo $row['blog_id']; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
											<? } ?>
                                                                ...
                                                                <li class="list-inline-item file-box">
                                                                    <div class=" custom-control custom-switch">
                                                                        ...
                                                                        <label class="custom-control-label" for="<?php echo $image_list[$i]; ?>">
                                                                            <img src="../admissionF/<?php echo $image_list[$i]; ?>" class="img-fluid img-thumbnail" alt="attached-img" width="80">
                                                                        </label>
                                                                    </div>
                                                                </li>
                                                    <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <? if($row['pdf_file']!=''){?>
                                                <a href="admission_upload.php?id=<?php echo $row['blog_id']; ?>&btnDeletepdf=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
											<? } ?>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='admissionView.php'; return false;" >Cancel</button>
                                        </div>
                                    </div>
                                            <?}?>
                                </form>
