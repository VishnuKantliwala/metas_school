                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="prod_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" id="cat_parent_id" name="cat_parent_id" value="<?php echo $parentid ?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="cat_name" name="cat_name" placeholder="School Life Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="dropify" type="file" id="frontimg" name="frontimg" />
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                ...
                                                &nbsp;&nbsp;
                                                <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='categoryview.php'; return false;" >Cancel</button>
                                            </div>
                                        </div>
