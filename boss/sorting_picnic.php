    ...
    $(document).ready(function(){ 
        ...
        $(function() {
            $(".sortable").sortable({ opacity: 0.6, cursor: 'move', update: function() {
                ...
                $.post("update_picnic.php", order, function(theResponse){
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h4 class="mt-0 header-title">Picnic List</h4>
                            <div class="card-box">
                            <div class="sortable">
                                <?php
								$query  = "SELECT * FROM tbl_picnic ORDER BY recordListingID ASC";
								$result = $cn->selectdb($query);
								
								while($row = mysqli_fetch_assoc($result))
								{
								?>
                                <div id="recordsArray_<?php echo $row['picnic_id']; ?>" class="card card-draggable">
                                    <div class="card-body bg-light">
                                        <p class="card-text"><?php echo $row['recordListingID'] . ". " . $row['picnic_name']; ?></p>
                                    </div>
                                </div>
								<?php } ?>
