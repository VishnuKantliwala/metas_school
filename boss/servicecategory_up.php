                        ...
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="service_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    $records=$con->selectdb("SELECT * FROM tbl_service_category  where cat_id=".$category_id."");
                                    ...
                                    ?>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-4">
											    <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[4]!=''){echo "../servicecategory/".$row[4];}?>"/>
                                            </div>
											<div class="col-sm-12">
                                                <input type="hidden" id="frontimg2" name="frontimg2" value="<?php echo $row[4]?>" />
                                                <?php if($row[4]!=''){?>
												    <a class="btn btn-lighten-danger" href="service_upload.php?id=<?php echo $row[0]; ?>&Image=Del" onClick="return confirm('Are you sure want to delete?');">Delete</a>
											    <?php }?>  
                                            </div>
                                        </div>
