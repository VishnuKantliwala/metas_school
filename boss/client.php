...
$con->connectdb();
	  ...
	  {	    
			...
			$clientImage = createImage('image_title',"../client/");
		...
		$con->insertdb("INSERT INTO `tbl_client` (`image_title`, `desc_client`, `client_name`,`meta_tag_title`, `meta_tag_description`, `meta_tag_keywords`) VALUES ('".$clientImage."', '".$desc_client."', '".$client_name."', '".$meta_tag_title."', '".$meta_tag_description."', '".$meta_tag_keywords."');");
                            ...
                            <div class="card-box">
								...
								<form class="form-horizontal" method="post" action="#" id="myform" name="myform" enctype="multipart/form-data">				
									...
									<div class="form-group">
										...
										<div class="col-sm-12">
											<textarea type="text" class="ckeditor" id="desc_client" name="desc_client" placeholder="Description"></textarea>
										</div>
									</div>
