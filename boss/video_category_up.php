            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 mb-2 header-title">Video Category Form</h4>
                                <form class="form-horizontal" method="post" action="video_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    <?php
                    
                                    $records=$con->selectdb("SELECT * FROM tbl_video_category  where cat_id=".$category_id."");
                                    ...
                                    ?>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-4">
											<input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[4]!=''){echo "../videocategory/".$row[4];}?>" />
											...
											<input type="hidden" id="frontimg2" name="frontimg2" value="<?php echo $row[4]?>" />
                                                <?php if($row[4]!=''){?>
												  <a href="video_upload.php?id=<?php echo $row[0]; ?>&Image=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
											    <?php }?>  
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
												...
												<button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='videoCatView.php'; return false;" >Cancel</button>
                                            </div>
                                        </div>
									<? } ?>	
                                </form>
