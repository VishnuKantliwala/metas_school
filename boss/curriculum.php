                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="curriculum_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="curriculum_name" name="curriculum_name" placeholder="Name">
                                        </div>
                                    </div>										
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="file" id="download_file" name="download_file" class="dropify" accept="application/pdf"  />
                                        </div>
                                    </div>

                                    <!-- <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Curriculum Video</label>
                                        <div class="col-sm-12">
                                            <textarea cols="5" rows="5" class="form-control" id="curriculum_video" name="curriculum_video" placeholder="Embeded code of the video"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" name="addCurriculum" id="addCurriculum" class="btn btn-success">Add</button>
