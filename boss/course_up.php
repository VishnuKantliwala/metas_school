    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">Course</h4>
                </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Course Form</h4>
                                <form class="form-horizontal" method="post" action="course_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    <input type="hidden" name="page" id="page" value="<? echo isset($_GET['page']);?>">

                                    <?php
                                    $records=$con->selectdb("SELECT * FROM tbl_course where course_id=".$course_id."");
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Course Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="course_name" name="course_name" placeholder="Course Name" value="<?php echo $row['course_name']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row['course_image']!=''){echo "../course/".$row['course_image'];}?>"/>
                                            <? if($row['course_image']!=''){?>
                                                <a href="course_upload.php?id=<?php echo $row['course_id']; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
											<? } ?>
											<input type="hidden" id="frontimg2" name="frontimg2" value="<?php echo $row['course_image']?>"  />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='courseView.php'; return false;" >Cancel</button>
                                        </div>
                                    </div>
                                            <?}?>
                                </form>
