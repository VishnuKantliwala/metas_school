...
$sql = $cn->selectdb("SELECT * FROM tbl_contactdetails order by contact_id desc");
...
function deleterecord($id)
{
    ...
    $cn->selectdb("delete from tbl_contactdetails where contact_id=$id");
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Contact Information View</h4>
                                <?php
									...
									for($i=0;$i<$cnt;$i++)
									{
										...
										echo "<script>window.open('contact_infoView.php','_SELF')</script>";
									}
								?>
                                        ...
                                        <div class="col-sm-12">
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                                ...
                                                if (mysqli_num_rows($sql) > 0) 
                                                {
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td><input type="checkbox" name="chkbox[]" class="chkbox"  value="<?echo $contact_id?>"/></td>
                                                            <td><?php echo $contact_id; ?></td>
                                                            <td><?php echo $contact_name; ?></td>
                                                            <td><?php echo $email; ?></td>
                                                            <td><a href='deleteContactInfo.php?Del=del&id=<?php echo $contact_id ?>&page=<?  if (isset($_GET['page']) && !empty($_GET['page'])) echo $_GET['page'];?>' onClick="return confirm('Are you sure want to delete?');"><i class="fa fa-trash"></i></a></td>
                                                        </tr>
                                                    <? } 
                                                } ?>
